...
import useGetRelatedLibraryItem from '~/hooks/library-items/use-get-related-libraryItem'
...
const BookRelatedTab = ({ libraryItemId }: Props) => {
  const router = useRouter()

  const { data: detailEditions, isLoading } = useGetRelatedLibraryItem(libraryItemId, {
    search: '',
    pageIndex: 1,
    pageSize: '5',
  })
